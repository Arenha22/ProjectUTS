...
namespace UTS
{
    ...
    internal class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            var ekor = new Asset3d(new Vector3(0, 0f, 0));//ekor
            ekor.AddCoordinates(0f, 0.5f, -0.5f);
            ekor.AddCoordinates(-0.3f, 0.5f, -0.53f);
            ekor.AddCoordinates(0.3f, 0.5f, -0.57f);
            ekor.AddCoordinates(0f, 0.5f, -0.7f);
            ekor.Bezier3d();
            ellipse1.child.Add(ekor);
            _objectList.Add(ekor);
            ...
            var kurva1 = new Asset3d(new Vector3(0.8f, 0, 0));
            kurva1.AddCoordinates(0, 0.9f, 0);
            kurva1.AddCoordinates(0f, 1.2f, 0);
            kurva1.AddCoordinates(0f, 1.25f, 0);
            kurva1.AddCoordinates(0.2f, 1.45f, 0);
            kurva1.Bezier3d();
            red1.child.Add(kurva1);

            var kurva2 = new Asset3d(new Vector3(0.8f, 0, 0));
            kurva2.AddCoordinates(0, 0.9f, -0.05f);
            kurva2.AddCoordinates(0.1f, 1.2f, -0.05f);
            kurva2.AddCoordinates(0.2f, 1.25f, -0.05f);
            kurva2.AddCoordinates(0.4f, 1.3f, -0.05f);
            kurva2.Bezier3d();
            red1.child.Add(kurva2);
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            {
                _objectList[0].scale(1.05f, 1.05f, 1.05f);
            }
            if (KeyboardState.IsKeyDown(Keys.KeyPad1))
            {
                _objectList[0].scale(0.95f, 0.95f, 0.95f);
            }
            ...
            {
                _objectListBlack[0].scale(1.05f, 1.05f, 1.05f);
            }
            if (KeyboardState.IsKeyDown(Keys.PageDown))
            {
                _objectListBlack[0].scale(0.95f, 0.95f, 0.95f);
            }
            ...
            {
                _objectListRed[0].scale(1.05f, 1.05f, 1.05f);
            }
            if (KeyboardState.IsKeyDown(Keys.KeyPad2))
            {
                _objectListRed[0].scale(0.95f, 0.95f, 0.95f);
            }
